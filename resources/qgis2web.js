...
map.getView().fit([385064.591916, 5305374.717850, 450188.304683, 5354831.105247], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Agri-PV Suitability Map for Emmendingen</h2>';
        return titleElement;
    })(),
